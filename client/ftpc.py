...
#clean-up
null_string = "\x00" * 1000 #null string is sent to tell server that UDP output is complete
end_struct = struct.pack("4shh1000s", s_local_ip, 4000, 1, null_string.encode('utf-8', 'ignore'))
