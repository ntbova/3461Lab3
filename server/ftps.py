...
while 1:
	...
	file_size = struct.unpack("Ihhi", data)
...
while 1:
	...
	file_name = struct.unpack("Ihh20s", data)
	server.sendto(data, addr)
	break
#DEBUG CODE
print (file_name)
